...
- Core taxonomic data are exported to and available at the [Catalogue of Life](https://www.catalogueoflife.org/data/taxon/8MP8D) and its [associated API](https://api.checklistbank.org/dataset/3LR/taxon/8MP8V).
